...
ggplot(CrossProf) +
       ...
       xlim(100,400) + # Sets the x-axis limits. Adjust this value as you zoom in to the correct area.
       ylim(1020,1060) + # Sets the y-axis limits. Adjust this value as you zoom in to the correct area.
       scale_color_gradient(low = "green", high = "brown") +
